...
/**
 * Command for creating a new webhook in the Mautic database.
 */
class CreateWebhookCommand extends Command
{
    protected static $defaultName = 'mautic:webhooks:create';
    ...
    {
        $this
            ->setDescription('Creates a new Mautic webhook in the database')
